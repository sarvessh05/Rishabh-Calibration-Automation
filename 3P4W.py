...
# ---------------- Calibration Steps -----------------
STEPS = [
    {"desc": "Unlock Calibration", "code": 2023, "wait": 0, "input_change": False, "busy_poll": False},  # 48
    {"desc": "Import Energy", "code": 901, "wait": 1, "input_change": False, "busy_poll": False},       # 49
    {"desc": "Poll Ready Step 1", "code": None, "wait": 0, "input_change": False, "busy_poll": True},  # 50
    {"desc": "Apply Input Step 2", "code": None, "wait": 0, "input_change": False, "busy_poll": False}, # 51
    {"desc": "Export Energy", "code": 910, "wait": 1, "input_change": False, "busy_poll": False},      # 52
    {"desc": "Poll Ready Step 2", "code": None, "wait": 0, "input_change": False, "busy_poll": True},  # 53
    {"desc": "Apply Input Step 3", "code": None, "wait": 0, "input_change": False, "busy_poll": False}, # 54
    {"desc": "Current Quantization", "code": 902, "wait": 1, "input_change": False, "busy_poll": False}, # 55
    {"desc": "Voltage Quantization", "code": 903, "wait": 1, "input_change": False, "busy_poll": False}, # 56
    {"desc": "Poll Ready Step 3", "code": None, "wait": 0, "input_change": False, "busy_poll": True},    # 58
    {"desc": "Apply Input Step 4", "code": None, "wait": 0, "input_change": False, "busy_poll": False},  # 59
    {"desc": "Export Vi Quantization", "code": 911, "wait": 1, "input_change": False, "busy_poll": False}, # 60
    {"desc": "Poll Ready Step 4", "code": None, "wait": 0, "input_change": False, "busy_poll": True},     # 61
    {"desc": "Save Coefficients", "code": 909, "wait": 2, "input_change": False, "busy_poll": False},     # 62
]

# Groups
CAL_GROUPS = [
    STEPS[0:3],    # Group 1 (48,49,50)
    STEPS[3:6],    # Group 2 (51,52,53)
    STEPS[6:10],   # Group 3 (54,55,56,58)
    STEPS[10:14],  # Group 4 (59,60,61,62)
]
